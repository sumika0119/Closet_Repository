...
def create_clothe(request):
    ...
    if request.method =='POST':
        ...
        if create_clothe_form.is_valid():
            ...
            # フォームがバリデーションエラーだった場合の処理
            print(create_clothe_form.errors) 
    ...
    return render(
        request, 'boards/create_clothe.html', context={
            'create_clothe': create_clothe_form,
